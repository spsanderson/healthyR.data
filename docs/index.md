...
- [`is_valid_url()`](https://www.spsanderson.com/healthyR.data/reference/is_valid_url.md) -
  Validate URLs before data fetching
...
MIT License - see
[LICENSE.md](https://www.spsanderson.com/healthyR.data/LICENSE.md) for
details
