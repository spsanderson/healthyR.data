...
- .data_sets:
  ...
  all of the data in the Payments data sets that are in the file. You
  ...
  only the Payments data sets are available to the function to choose
...
This function will obtain the current Payments data from the output of
the
[`current_hosp_data()`](https://www.spsanderson.com/healthyR.data/reference/current_hosp_data.md)
